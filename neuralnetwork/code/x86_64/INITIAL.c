...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 initial /home/jovyan/work/neuralnetwork/code/mod_files/INITIAL.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jovyan/work/neuralnetwork/code/mod_files/INITIAL.mod";
static const char* nmodl_file_text = 
  ":INITIAL SEGMENT\n"
  "\n"
